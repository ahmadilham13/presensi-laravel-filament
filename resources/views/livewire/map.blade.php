<div class="grid grid-cols-1 dark:bg-gray-900 md:grid-cols-12 gap-4" wire:ignore>
    ...
    <div class="md:col-span-12 bg-white dark:bg-gray-900 shadow-md rounded-lg p-6">
    ...
    <script>
        document.addEventListener('livewire:initialized', function () {
            ...
            let map = L.map('map').setView([0.7893, 113.9213], 4.5);

            L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
                atttribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
            }).addTo(map);
